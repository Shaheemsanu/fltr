        ...
        child: Padding(
          ...
          child: Container(
            ...
            decoration: BoxDecoration(
              ...
              image: NetworkImage("https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSO9nC9pzEf37ejs2Wy05FLo7nze6z0O_LxlxfsH9-QvZD9V70weUVVfTCbuQqjkHAtuwc&usqp=CAU"),
              fit: BoxFit.fitWidth,
            ),
              border: Border.all(
                color: Colors.grey,
              ...
              validator: (text){
                ...
                return null;
                    ...
                    TextButton(onPressed: (){
                      Navigator.push(context, MaterialPageRoute(builder: (context) => regtn()));
