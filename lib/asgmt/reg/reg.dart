            ...
            child: Column(
              ...
              validator: (text){
                if (!EmailValidator.validate(text!) || text.isEmpty) {
                     ...
                     validator: (text){
                if(text==null || (text.length<=8) || text.isEmpty){
